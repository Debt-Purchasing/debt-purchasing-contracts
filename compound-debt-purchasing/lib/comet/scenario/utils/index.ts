...
export async function createCrossChainProposal(
  ...
  switch (bridgeNetwork) {
    case "arbitrum": {
      const inbox =
        await govDeploymentManager.getContractOrThrow("arbitrumInbox");
    ...
    case "scroll": {
      ...
      const scrollMessenger =
        await govDeploymentManager.getContractOrThrow("scrollMessenger");
    ...
    case "ronin": {
      const l1CCIPRouter =
        await govDeploymentManager.getContractOrThrow("l1CCIPRouter");
